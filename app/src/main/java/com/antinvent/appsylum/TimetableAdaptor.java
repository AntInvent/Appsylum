...
public class TimetableAdaptor extends BaseExpandableListAdapter {
    ...
    TimetableAdaptor(Context context, List<String> daysList, HashMap<String, List<String>> eventsHashMap){
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView textView = (TextView) convertView.findViewById(R.id.eventTitleTextView);
